...
const translations: Translations = {
    zh: {
        ...
        "ai_poetry_click_mode": "AI 填诗后点击按钮",
        "sign_time": "签到时间 (CRON)",
        ...
        "action_ai_poetry_click": "AI 填诗后点按钮",
    ...
    en: {
        ...
        "ai_poetry_click_mode": "AI Poetry Fill Click",
        ...
        "action_ai_poetry": "AI Poetry Fill",
        ...
        "action_ai_poetry_click": "AI Poetry Fill Click Button",
...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
    ...
    useEffect(() => {
        const savedLang = localStorage.getItem('tg-signer-lang') as Language | null;
